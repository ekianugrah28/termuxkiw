...
print(b+'\t  By : Eki Anugrah Ramadhan')
print('\t web : ekiganteng24.blogspot.com')
print('\t Facebook : fb.me/mhmmdekisdhga28')
print('\t Github : https://github.com/ekianugrah28/termuxkiw')
print(a+'+'*40)
print('\nProses..')
sleep(1)
